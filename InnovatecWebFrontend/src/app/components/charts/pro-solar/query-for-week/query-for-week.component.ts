...
@Component({
  selector: 'app-query-for-week',
  templateUrl: './query-for-week.component.html',
  styleUrls: ['./query-for-week.component.css']
})
export class QueryForWeekComponent implements OnInit {
  ...
  public realTimeList1: DatosProSolar[] = [];
  ...
  public realTimeList2: DatosProSolar[] = [];
  ...
  public realTimeList3: DatosProSolar[] = [];
  ...
  promedioData() {
    ...
    this.fullDataList.forEach(element => {
      ...
      console.log('tamaño lista: ' + contador);
  ...
  InputValuesChart() {
    ...
    this.charDataSets = { data: this.dataValues, label: this.valueLabel };
    this.charDataSets1 = { data: this.dataValues1, label: this.valueLabel1 };
    this.charDataSets1 = { data: this.dataValues2, label: this.valueLabel1 };
    this.charDataSets1 = { data: this.dataValues3, label: this.valueLabel1 };
  ...
  exportar() {
    ...
    const fullNameFile =  fDay + '-' + fMonth + '-' + fYear + ' a ' + lDay + '-' + Month + '-' + lYear + ' datos-prosolar'  ;
